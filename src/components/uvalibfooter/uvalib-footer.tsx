...
export class UvalibFooter {
   ...
   *
   */
  @Prop() _currentYear: string = new Date().getFullYear().toString();
        ...
        <slot name="bottom-bar">
            ...
            <iron-dropdown id="copydrop"
              ...
              horizontal-align="left">
                <div slot="dropdown-content">
                  <div id="copyright-info" class="copyright"><span role="img" arial-label="copyright">©</span> {this._currentYear} by the Rector and Visitors of the University of Virginia</div>
                </div>
            </iron-dropdown>
          ...
          <div class="fdl">
            ...
            <a href="https://guides.lib.virginia.edu/findinggovinfo" id="fdl">
              <svg alt="This library is a Congressionally designated depository for U.S. Government documents. Public access to the Government documents is guaranteed by public law." on-mouseover="_fdlpDropup" on-mouseout="_fdlpDropdown" width="50px" viewBox="0 0 76 69" version="1.1" xmlns="http://www.w3.org/2000/svg">
